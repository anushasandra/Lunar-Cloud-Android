...
public class Post_page_adapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		comment2 = (TextView) itemView.findViewById(R.id.comment_id_feed_page);
		...
		comment2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(context, "commented you", Toast.LENGTH_LONG)
				.show();
			Intent cmt=new Intent(context,list_comment.class);
			}
		});
